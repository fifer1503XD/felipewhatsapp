...
import { newMessage, sendMessage,deleteConversation } from "../../actions/conversationActions";
...
const Chat =  () => {
  ...
  const deleteChat=()=>{
    dispatch(deleteConversation(idConversation,idActive));
