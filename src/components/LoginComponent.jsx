...
import {login,checkActiveSession,verifyRegisterApi} from "../actions/authActions";
    ...
    const signIn = async(event, provider) => {
      event.preventDefault();
        ...
        if(provider ==="email" && (refEmail.current.value=== "" || refPassword.current.value === "")){
          ...
          try{
        await dispatch(login(provider, refEmail.current.value, refPassword.current.value,userMessenger));
